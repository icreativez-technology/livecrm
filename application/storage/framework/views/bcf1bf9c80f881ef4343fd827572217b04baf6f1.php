<head>
    ...
    <script src="https://livecrm.org/public/vendor/js/vendor.header.js?v=<?php echo e(config('system.versioning')); ?>"></script>
    <link href="https://livecrm.org/public/vendor/css/bootstrap/bootstrap.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,700" rel="stylesheet"
        type="text/css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://livecrm.org/public/vendor/css/vendor.css?v=<?php echo e(config('system.versioning')); ?>">
    <link rel="stylesheet" href="https://livecrm.org/public/vendor/fonts/growcrm-icons/styles.css?v=<?php echo e(config('system.versioning')); ?>">
    <link href="https://livecrm.org/public/themes/default/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
                  <link href="https://livecrm.org/public/css/mobiscroll.jquery.min.css"
        rel="stylesheet">
    <?php if(auth()->check()): ?>
    <link
        href="https://livecrm.org/public/themes/<?php echo e(auth()->user()->pref_theme); ?>/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
    <?php else: ?>
    <link href="<?php echo e(config('theme.selected_theme_css')); ?> " rel="stylesheet">
    <?php endif; ?>
    
    <link href="https://livecrm.org/public/css/custom.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    <link href="https://livecrm.org/public/css/print.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    ...
    <!--boot js-->
    <script src="https://livecrm.org/public/js/core/head.js?v=<?php echo e(config('system.versioning')); ?>"></script>
...
</head><?php /**PATH /home/livecrm/public_html/application/resources/views/layout/header.blade.php ENDPATH**/ ?>