<head>
    ...
    <link href="livecrm/public/themes/default/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
                  <link href="livecrm/public/css/mobiscroll.jquery.min.css"
        rel="stylesheet">
    <?php if(auth()->check()): ?>
    <link
...
</head><?php /**PATH C:\xampp\htdocs\livesoft\livecrm\application\resources\views/layout/header.blade.php ENDPATH**/ ?>